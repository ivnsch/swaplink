        ...
        <div className="container">
          ...
          <header className="header">
            <div className="logo" aria-label="swaplink logo">
              ...
              >
                <path d="M3.61558 0.0477295V0.925628V8.82671H10.4437V11.1027C10.4112 11.688 10.2811 12.1107 9.53326 12.1107H0.299072L0.331587 6.87583V0.990658C0.331587 0.372877 0.62422 0.0477295 1.27451 0.0477295H3.61558Z" />
                <path d="M13.435 15.3948L13.4675 12.8911V6.61578H6.6394V4.17717C6.67192 3.62442 6.99707 3.33179 7.58233 3.33179H16.7515V9.54211V14.3218C16.7515 14.9721 16.6214 15.3948 15.8411 15.3948H13.435Z" />
              </svg>
          ...
          <footer className="footer">
            ...
            <a
              href="https://twitter.com/swaplinkxyz"
              target="_blank"
              rel="noreferrer"
              className="footer__item"
            >
            ...
            <a
              href="https://discord.com/invite/8vVyw8xjVw"
              target="_blank"
              rel="noreferrer"
              className="footer__item"
            >
